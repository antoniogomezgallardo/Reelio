...
- The feed applies a simple genre diversity heuristic to reduce repetition within a page.
...
- Images are rendered with `next/image` and allowlisted for TMDB posters.
